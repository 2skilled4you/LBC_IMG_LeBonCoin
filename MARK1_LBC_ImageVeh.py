...
py_process = Popen([r'C:\Users\Bernard\Documents\Python Scripts\60. Outils\clearcache.bat'], stdout=PIPE, stderr=STDOUT)

time.sleep(5)

py_process = Popen([r'C:\Users\Bernard\Documents\Python Scripts\60. Outils\LaunchChromeExperimental.bat'], stdout=PIPE, stderr=STDOUT)
